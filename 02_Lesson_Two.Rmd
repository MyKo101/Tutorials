...
I've uploaded a [messy dataset](data/data_anthro.csv) online for us to use today. Right click the link and then download the file. Save it somewhere useful (maybe in a new folder).
...
```{r}
dat <- read_csv("data/data_anthro.csv")
```
...
Let's bring in a new [dataset](data/data_score.csv) and try it out!

```{r}
dat_score <- read_csv("data/data_score.csv",
                      col_types=cols())
dat_score
```
