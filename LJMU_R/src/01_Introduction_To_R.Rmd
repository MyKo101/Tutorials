...
c(TRUE,FALSE)
```
Notice that this time, the "hello" and "world" are shown to be seperate, rather than earlier when they were a single string.
...
As previously shown, data can be assigned to a, this includes vectors.
