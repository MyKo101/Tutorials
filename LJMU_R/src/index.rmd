...
Welcome to the Lecture Notes for LJMU's R Tutorial. Please use the contents list on the left to browse through the notes. You can expand or minimise the contents by clicking the three bars (![](images/Three_Bars.png){#id .class height=16px}) in the top left.
